...
RUN apt-get update
RUN apt-get install -y php7.1 php7.1-bcmath php7.1-bz2 php7.1-cli php7.1-common php7.1-curl \
    php7.1-cgi php7.1-fpm php7.1-gd php7.1-gmp php7.1-imap php7.1-intl \
...
RUN apt-get update
RUN curl --proxy http://192.168.1.2:3128 -sL https://deb.nodesource.com/setup_8.x | bash -
